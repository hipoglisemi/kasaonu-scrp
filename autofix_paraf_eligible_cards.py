...
def main():
    ...
    print(f"Successfully parsed {total_parsed} campaign updates from the report.")
    ...
    try:
        ...
        db.commit()
        print(f"\n🎉 SUCCESS: Successfully updated {success_count} campaigns in the database!")
        print("All audited campaigns have been marked as is_audited=True and updated with flawless card lists!")
