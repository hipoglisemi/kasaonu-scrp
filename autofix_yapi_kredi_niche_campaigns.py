...
def main():
    ...
    print(f"Successfully parsed {total_parsed} niche campaign updates from the report.")
    ...
    try:
        ...
        db.commit()
        print(f"\n🎉 SUCCESS: Successfully updated {success_count} niche campaigns in the database!")
        print("All audited niche campaigns (Crystal, Adios, Play) have been marked as is_audited=True and updated with clean card lists!")
