...
try:
    ...
    # Estimate for 2000 campaigns
    est_input_tokens = avg_tokens * 2000
    # Prompt is around 200 tokens
    ...
    print(f"Estimated Input Tokens for 2000 camps: {est_total_input:.0f}")
    print(f"Estimated Output Tokens for 2000 camps: {est_output_tokens:.0f}")
