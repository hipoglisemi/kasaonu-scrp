...
3. **KARTLAR ve KATILIM**: 
   ...
   - 🚨 ZİRAAT BANKKART KURALI (ÇOK KRİTİK): Ziraat Bankası kampanyalarında; eğer kampanya metninde 'Bankkart Gençlilere' vurgusu varsa, 'cards' alanına SADECE 'Bankkart Genç' yaz; başka hiçbir kart ekleme. Eğer metin genel olarak 'Bireysel Bankkart' veya 'Bankkart' diyorsa sadece 'Bankkart' ve 'Bankkart Genç' yaz (Ticari kartları, Business, Başak ASLA ekleme). 'Bankkart Prestij' veya 'Prestij Plus' kartları KESİNLİKLE sadece kampanyaya açıkça dahil edildiklerinde yazılmalıdır (Örn: 'Prestij kartlar da yararlanabilir'). Eğer metinde sadece 'Katlanan Jest Lira özelliği kapsamında kullanılamaz' uyarısı geçiyorsa bu, kampanyanın Prestij'e yönelik olduğu anlamına GELMEZ; bu markaları 'cards' veya 'conditions' listesine ASLA ekleme. Ayrıca metin 'ek kartlar' veya 'sanal kartlar' geçerli diyorsa bu terimleri de aynen listeye ekle. Açıkça adı geçmeyen hiçbir kartı ezbere UYDURMA.
   ...
   - 🚨 CHİPPİN KURALI (ÇOK KRİTİK): Chippin kampanyalarında, eğer metinde genel olarak "bireysel kredi kartı" veya "kredi veya banka kartı" gibi bir ifade geçiyorsa bunu KESİNLİKLE göz ardı etme ve ilgili bankanın adıyla birlikte (Örn: "Yapı Kredi bireysel kredi kartları" veya "Yapı Kredi banka kartları") 'cards' listesine EKSİKSİZ ekle. Sadece Debit kart yazıp asıl Kredi kartlarını asla unutma.
   - 🚨 PARAF PREMIUM TRAP (ÇOK KRİTİK): Paraf kampanyalarının metinlerinde genellikle "Paraf Premium'u Keşfedin", "Premium'a Özel..." gibi başka kampanyaların reklamları yer alır. Bu reklam metinlerini GÖRMEZDEN GEL ve kampanya başlığı/ana şartı açıkça "Paraf Premium'a Özel" demiyorsa KESİNLİKLE "Paraf Premium" kartını listeye ekleme. Onun yerine sadece "Paraf" yaz.
   - 🚨 VODAFONE KURALI (ÇOK KRİTİK): Vodafone kampanyalarında metinde geçen "Fırsatı Kullan butonuna tıklayarak şifre alabilirsiniz", "Vodafone Yanımda uygulamasından fırsatı kullan", "SMS gönderin" gibi ADIM ADIM KATILIM ve ŞİFRE ALMA YÖNERGELERİNİ KESİNLİKLE 'ai_marketing_text' (Pazarlama Metni) içine YAZMA. Bu tür teknik katılım talimatları SADECE 'participation' kolonunda yer almalıdır.
   - 🚨 HOPİ KURALI (ÇOK KRİTİK): Hopi kampanyalarında kullanıcının kampanyadan faydalanabilmesi için mutlaka Hopi platformu üzerinden ilgili markaya yönlenmesi veya mağazada Hopi QR kodunu okutması gerekmektedir. Eğer kampanya bir Hopi kampanyası ise, metnin en başında yer alan "[Hopi Aksiyon Butonu: XXX]" ibaresindeki XXX metnini kullanarak, 'participation' (Katılım Şekli) alanının sonuna MUTLAKA "Kampanyadan faydalanmak için Hopi platformu üzerinden 'Xxx Xxx' (buton adının sadece baş harfleri büyük olacak şekilde) butonuna tıklayarak ilerlemelisiniz." uyarısını ekle. (Eğer buton adı geçmiyorsa 'Kampanyadan Faydalan' olarak varsay).
   - 🚨 **MÜŞTERİ KİTLESİ / SEGMENTİ KURALI**: Eğer kampanya koşullarında herhangi bir kart adı (Axess, Wings, kredi kartı vb.) geçmiyorsa, ancak kampanya belirli bir müşteri kitlesine yönelikse (örn. "Mobilin Akbanklısı" veya "İlk kez Akbanklı olanlar" deniyorsa), `cards` listesine "Akbank Mobil Müşterileri" veya "İlk Kez Akbanklı Olanlar" gibi o kitle adını yaz.
   - ⛔ YASAK: Eğer metinde geçerli kart/müşteri adı (örn: 'Opet Kart', 'Türk Telekom müşterileri') veya belirli bir müşteri kitlesi geçmiyorsa ASLA uydurarak ekleme. Yoksa boş bırak `[]`.
